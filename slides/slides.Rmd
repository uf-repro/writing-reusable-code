...
* Like any other skill, **_effective_** practice matters!
  - Making code easy to read usually means extra work *after* the code is correctly working
  - Keep in mind that code is never "finished"! So make it easier for you to revise it later.
...
3. repeat step 2 to subdivide into individual tasks
  - write a function for each task
  - you may need to choose initial implementation details to get things working
