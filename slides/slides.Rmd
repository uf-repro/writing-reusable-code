...
* In addition to code that **works correctly**, ideally it is also:
...
* Like any other skill, **_effective_** practice matters!
  - correctly working code isn't necessarily easy to read or maintain
  - keep in mind that you will almost always need to fix or revise the code later
...
--
* BUT, it enables:
  - performing the same operation on different inputs (e.g. datasets, variables, parameter values, etc.)
  - the structure of your code can communicate how it works
...
* If we need to fix or change the operation, only the function needs to be changed.
* It is easier to find where to change it, because of the function name.
* Someone reading the code can understand it without details.  
...
* width and height are adjustable, but have defaults that will work
...
* the ability to recognize "code smells" depends on experience
